...
TEST_CASE("DateTime class tests 2", "[LAB2]") {
    Date f, d(22, 8, 1337, 7, 33, 1), e(1, 2, 2007, 2, 3, 4);
    ...
    REQUIRE(strcmp((char*) h, "12/5/669 18:30:3") == 0);
}
TEST_CASE("DateTime class tests 3", "[LAB3]") {
    Date bb, aa(15, 3, 1984, 12, 4, 13);
    fstream file;
